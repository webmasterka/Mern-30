...
// Import Actions
import { fetchPost, editPostRequest, voteUpPostRequest, voteDownPostRequest } from '../../PostActions';
  ...
  renderPost = () => {
    return (
      <div className={`${styles['single-post']} ${styles['post-detail']}`}>
        ...
        <p className={styles['post-rating']}><FormattedMessage id="rating" /> {this.props.post.voteCount}</p>
      </div>
    );
  };
...
function mapDispatchToProps(dispatch, props) {
  return {
    ...
    editPostRequest: (post) => dispatch(editPostRequest(this.props.params.cuid, post))
  };
}
